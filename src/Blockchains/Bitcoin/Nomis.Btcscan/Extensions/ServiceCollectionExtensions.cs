...
namespace Nomis.Btcscan.Extensions
{
    /// <summary>
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        internal static IServiceCollection AddBtcscanService(
            this IServiceCollection services)
        {
            ...
            services.AddSettings<BtcscanSettings>(configuration);
            return services
                .AddTransient<IBtcscanClient, BtcscanClient>()
                .AddTransientInfrastructureService<IBtcScoringService, BtcscanService>();
        }
    }
}