// ------------------------------------------------------------------------------------------------------
// <copyright file="BtcWalletScore.cs" company="Nomis">
...
namespace Nomis.Btcscan.Interfaces.Models
{
    ...
    /// Btc wallet score.
    /// </summary>
    public class BtcWalletScore :
        IWalletScore<BtcWalletStats, BtcTransactionIntervalData>
    {
        /// <summary>
        /// Wallet address.
        /// </summary>
        ...
        /// </summary>
        public BtcWalletStats? Stats { get; set; }
    }
}