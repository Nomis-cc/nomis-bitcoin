// ------------------------------------------------------------------------------------------------------
// <copyright file="BtcTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.Btcscan.Interfaces.Models
{
    ...
    public class BtcTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToBtc();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToBtc();
        ...
        public decimal AmountInSumValue => AmountInSum.ToBtc();
